...
pet1 = Mascota('Sr. Spok', 'gato', 10)
pet2 = Mascota('Toby', 'gato', 11)
pet3 = Mascota('Kali Uchis', 'gato', 4)
pet4 = Mascota('Jake', 'perro', 34)
pet5 = Mascota('James Baxter', 'caballo', 58)

vet = Veterinaria("Porvenir")
...
pregunta1 = Pregunta('Quien pinto la Mona Lisa?', 'Leonardo DaVinci')
pregunta2 = Pregunta('Cual es el hueso mas largo del cuerpo?', 'El femur')
pregunta3 = Pregunta('Cual es la capital de Rusia?', 'Moscu')
pregunta4 = Pregunta('Cual es el mejor pais de Chile?', 'Chile')
pregunta5 = Pregunta('Como salgo de Vim?', 'Alt+F4')
pregunta6 = Pregunta('Cuantos pares son tres moscas?', '...')

psu = Examen('PSU')

psu.agregar_pregunta(pregunta1)
psu.agregar_pregunta(pregunta2)
psu.agregar_pregunta(pregunta3)
psu.agregar_pregunta(pregunta4)
psu.agregar_pregunta(pregunta5)
psu.agregar_pregunta(pregunta6)

psu.listar_preguntas()
p()
psu.ver_respuesta(pregunta6)
